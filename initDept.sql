...
VALUES
		(NULL, '1', 'admin@gmail.com', 'admin', '$2a$10$Kk5EMeUstEd3Ykr4zLzcBujImTEoIXHL2z1Dtjq11cvPqf5rfUeca', 'admin', 'admin'),
		('1', '2', 'user@gmail.com', 'user', '$2a$10$dm7yhx4IpIXJ4Plc3cMdVuo0rnMTWuzALAEFv4mLF2ez40Jc2pG9K', 'USER', 'user'),
		('2', '3', 'user2@gmail.com', 'user2', '$2a$10$nFdviG20VyapnrNea6xud.XVclxw5nj2ft4jLXcsMYqjxu8mLOiJu', 'USER', 'user2'),
		('3', '4', 'user3@gmail.com', 'user3', '$2a$10$oOQL1GbGEGY4GTSHigERvuWP54dtcVq8WGHQ3VJ3rHuDxKHLmJV2C', 'USER', 'user3');